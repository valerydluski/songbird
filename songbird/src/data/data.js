...
const birdsData = [
  [
    ...
    },
    {
      ...
      description:
        'Evanescence — американская рок-группа, основанная в 1995 году. Среди критиков нет единства во мнениях относительно того, как классифицировать музыку Evanescence: как рок или как метал.',
    ...
    },
    {
      ...
      description:
        'Bullet For My Valentine — британская металкор-группа. Была сформирована в 1998 году в городе Бридженд под названием Jeff Killed John. 2003 год стал годом больших перемен касаемо названия, стиля и состава.',
    ...
    },
    {
      ...
      description:
        'Puddle of Mudd — американская рок-группа, сформированная в Канзас-Сити, штат Миссури в 1991 году. Группа выпустила 2 независимых и 5 мэйджорных студийных альбомов.',
    ...
    },
    {
      ...
      description:
        'Green Day — американская панк-рок группа, основанная в 1986 году.В 2011 году трио было признано лучшей панк-группой в истории музыки по результатам опроса, проведённого журналом Rolling Stone. В 2015 году Green Day были включены в «Зал славы рок-н-ролла».',
  ...
  [
    {
      ...
      species: 'Radioactive',
      description:
        '«Imagine Dragons» — американская инди-рок-группа, образованная в 2008 году в городе Лас-Вегас, США. Американский журнал Billboard назвал их самыми яркими новыми звёздами 2013 года и самой большой группой 2017 года.',
    ...
    },
    {
      ...
      species: 'In The End',
      description:
        'Linkin Park — американская рок-группа, основанная в 1996 году под названием Xero. Существуя с 2000 года под названием Linkin Park, группа была шесть раз номинирована и два раза удостоилась награды «Грэмми»',
    ...
    },
    {
      ...
      audio: `${LINK_FOR_AUDIO}Black%20Veil%20Brides%20-%20Days%20Are%20Numbered%20(feat.%20Bert%20Mccracken%20of%20The%20Used).mp3`,
    },
    {
      id: 4,
      name: 'Metallica',
      ...
      description:
        'Metallica — американская метал-группа, образованная в 1981 году, в Лос-Анджелесе. Metallica оказала большое влияние на развитие метала и входит в «большую четвёрку трэш-метала». Альбомы Metallica были проданы в общей сложности в количестве более 110 миллионов экземпляров по всему миру.',
    ...
    },
    {
      ...
      species: 'Starlight',
      description:
        'Muse — британская рок-группа, образованная в 1994 году в городе Тинмут (графство Девон). Всего Muse выпустили восемь студийных альбомов и два концертных альбома, продажи которых превысили 20 млн.',
    ...
    },
    {
      ...
      description:
        'My Chemical Romance — американская рок-группа, основанная в конце 2001 года в Ньюарке, Нью-Джерси. Различные критики относили My Chemical Romance к альтернативному року, эмо (что члены группы отрицают) и другим жанрам.',
  ...
  [
    {
      ...
      species: 'Photograph',
      description:
        'Nickelback — канадская альтернативная рок-группа, основанная в 1995 году в городе Ханна. Группа попала в список лучших артистов первого десятилетия XXI века, по мнению Billboard, где заняла первое место среди рок-групп.',
    ...
    },
    {
      ...
      species: 'Sappy',
      description:
        'Nirvana — американская рок-группа, созданная вокалистом и гитаристом Куртом Кобейном и басистом Кристом Новоселичем в Абердине, штат Вашингтон, в 1987 году. Недолгая, но яркая история группы прервалась в связи со смертью Курта Кобейна 5 апреля 1994 года.',
    ...
    },
    {
      ...
      description:
        'Scorpions — немецкая англоязычная рок-группа, созданная в 1965 в Ганновере.Scorpions являются самой популярной рок-группой Германии и одной из самых известных в мире, продав более 100 миллионов копий своих альбомов.',
  ...
  [
    ...
    },
    {
      ...
      species: 'Metro',
      description:
        'System of a Down — армяно-американская рок-группа, образованная в 1992 году в Лос-Анджелесе, а в 1995 принявшая нынешнее название. В период с 1998 по 2005 год группа выпустила пять студийных альбомов, каждый из которых стал платиновым.',
